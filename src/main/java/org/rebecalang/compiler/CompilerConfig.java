...
public class CompilerConfig {
	...
	@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
	public SymbolTableInitializer getLinguaFrancaSymbolTableInitializer() {
		SymbolTableInitializer symbolTableInitializer = new SymbolTableInitializer(appContext.getBean(TimedRebecaTypeSystem.class));
		return symbolTableInitializer;
	}
	...
	@Qualifier("TIMED_REBECA_LINGUA_FRANCA")
	@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
	public TypeSystemInitializer getLinguaFrancaTypeSystemInitializer() {
		TypeSystemInitializer typeSystemInitializer = new TypeSystemInitializer(appContext.getBean(TimedRebecaTypeSystem.class));
		return typeSystemInitializer;
	}
