...
A **general**-family positive benchmark: a DTR-fragment redesign of the ordering and composition model `Periodic_PingPong_Composition`, which the model checker rejects with a queue overflow.
