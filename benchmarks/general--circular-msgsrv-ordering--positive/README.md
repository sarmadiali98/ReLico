...
A **general**-family positive benchmark from the ordering and composition corpus authored for this evaluation (`Deterministic_Circular_Ordering_messageserver.rebeca`), integrated without adaptation.
