...
A **general**-family positive benchmark from the ordering and composition corpus authored for this evaluation (`Trigger_Activated_PingPong_Composition.rebeca`), integrated without adaptation.
