...
The fixture source is byte-identical to `lf-lang/lf-verifier-benchmarks, benchmarks/src/ProcessMsg.lf rendered to Timed Rebeca (adapted, not used verbatim)`.
