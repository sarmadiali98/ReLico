...
- **Original source:** `lf-lang/lf-verifier-benchmarks, benchmarks/src/Factorial.lf rendered to Timed Rebeca (adapted, not used verbatim)`, 84 lines, one of the paper's RQ1 verification benchmarks.
